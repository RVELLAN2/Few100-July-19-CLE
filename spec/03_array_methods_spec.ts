...
describe('Array Methods', () => {
    describe('examples', () => {
        ...
        describe('methods that prodce a new array', () => {
            it('has a filter', () => {
                const evens = numbers.filter(isEven);
                expect(evens).toEqual([2, 4, 6, 8]);
            });
            it('creating a new array from each', () => {
                const doubled = numbers.map(num => num * 2);
                expect(doubled).toEqual([2, 4, 6, 8, 10, 12, 14, 16, 18]);

                const stringEvens = numbers.filter(isEven).map(num => num * 2).map(num => num.toString());
    ...
    describe('practical use', () => {
        ...
        it('your practice 1', () => {
            ...
            // const answer = // The make and model of all vehicles with > 100_000 miles on them.
        ...
        it('second practice with data', () => {
            ...
            // 1. I want an array of names, email, pahone of each active customer with a balance > $1,000.00
            interface Answer1 {
                name: string;
                email: string;
                phone: string;
