...
//import { isEven as otherIsEven } from '../src/utils';
...
describe('function and objects', () => {
    describe('function literals', () => {
        it('the syntai', () => {
            ...
            const factorial = function (x: number) {
        ...
        it('intro to higer-ordered function', () => {
            ...
            //    return n % 2 === 0;
            //}
            // moved to utils and improted

            //const evens = numbers.filter(fromUtils.isEven);
            //const evens = numbers.filter(otherIsEven);
    ...
    describe('arguments to fuctions', () => {
